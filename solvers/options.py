...
class SNOPT_options(OptionsClass):
    ...
    def setup(self):
        self.options = {
            ...
            'Specs filename'        : [None,None,str],  ##
            # 'Specs filename'        : ['SNOPT_specs.out','SNOPT_specs.out',str],

            'Print filename'        : ['SNOPT_print.out','SNOPT_print.out',str],  ##
            'Print frequency'       : [None,None,int],
            'Print level'           : [None,None,int], # minor print level

            'Summary'               : ['yes','yes',str],
            'Summary filename'      : ['SNOPT_summary.out','SNOPT_summary.out',str],
            'Summary frequency'     : [None,None,int],

            'Solution file'         : [None,None,int],
            'Solution filename'     : ['SNOPT_solution.out','SNOPT_solution.out',int],
            'Solution print'        : [None,None,bool],
